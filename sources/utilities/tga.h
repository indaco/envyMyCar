...
/* class: CTargaImage
 *
 *  Classe di utilita' per la manipolazione di immagini TGA
 */
class CTargaImage {
private:
...
public:
    ...
    /* method: ConvertRGBAToRGB */
    bool ConvertRGBAToRGB();
    
    /* method: ConvertRGBToRGBA */
    bool ConvertRGBToRGBA(unsigned char alphaValue);

    /* method: GetImage
     *
     *  Restiruisce l'immagine corrente
     */
